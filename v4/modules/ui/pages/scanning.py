...
def process_all_tickets_in_folder() -> None:
    ...
    for ticket_file in tickets:
        ...
        with st.form(f"form_{ticket_file}"):
            ...
            description_ticket = st.text_input("📝 Description (optionnel)", placeholder="Ex: Carrefour, Leclerc, etc.")
        ...
        if valider:
            ...
            insert_transaction_batch([{
                ...
                "source": "OCR",
                "description": description_ticket.strip() if description_ticket else ""
            }])
