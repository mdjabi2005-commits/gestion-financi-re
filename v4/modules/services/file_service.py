"""File management service for transaction-associated files.

This module handles finding, moving, and deleting files associated with
transactions (receipts, invoices, etc.) in the organized directory structure.
"""
