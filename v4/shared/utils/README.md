...
|-------------|-------------|-------------|
| `pandas` | Manipulation de données (converters) | ≥1.3 |
| `python-dateutil` | Parsing dates (converters) | ≥2.8 |
| `regex` | Patterns avancés | ≥2020.0.0 |

**Installation** :
```bash
pip install pandas python-dateutil regex
```
