...
from modules.ui.toast_components import toast_success, toast_warning, toast_error
            ...
            if categorie_rec and categorie_rec.strip() and montant_rec > 0:
                try:
                    cursor.execute("""
                        ...
                        (type, categorie, montant, date_debut, date_fin, frequence, description, statut, date_creation, date_modification)
                        VALUES (?, ?, ?, ?, ?, ?, ?, 'active', ?, ?)
                    """, (
                        type_rec,
                        categorie_rec.strip(),
                    ...
                    from modules.services.recurrence_generation import generate_occurrences_for_recurrence
