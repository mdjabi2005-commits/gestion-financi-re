...
from modules.ui.pages.portfolio.manage import render_manage_tab
from modules.ui.pages.portfolio.analyze import render_analyze_tab
...
def interface_portefeuille() -> None:
    ...
    from modules.services.recurrence_generation import refresh_echeances
    refresh_echeances()
