"""
Recurrence Service - Generation Logic

Service pour générer les occurrences de transactions à partir de la table recurrences.
Compatible avec le nouveau schéma (table recurrences séparée).
"""
