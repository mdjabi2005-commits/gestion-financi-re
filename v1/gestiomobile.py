# -*- coding: utf-8 -*-
"""
Created on Wed Nov 12 19:36:17 2025
...
# ==============================
# 📄 Configuration de l'interface téléphone
# ==============================
class HomeScreen(MDScreen):
    def __init__(self, **kwargs):
        ...
        self.add_widget(
            MDLabel(
                text="Bienvenue dans Gestion Financière Little 📱",
                halign="center",
...
class GestioApp(MDApp):
    title = "Gestion Financière Little"
    def build(self):
